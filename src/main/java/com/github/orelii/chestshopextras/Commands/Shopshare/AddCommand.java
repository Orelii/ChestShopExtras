...
public class AddCommand {
    ...
    public static void addCommand(Player sender, String argument) throws IOException {
        ...
        if (sender.getName().equalsIgnoreCase(argument)) {
            sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <red>You can already open your shop chests!</red>"));
            return;
        }
        ...
        if (!insideTrustedClaim(sender, player)) {
            ...
            if (!trusted.contains(target.getUniqueId().toString())) {
                ...
                sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <red>That player is already globally trusted!</red>"));
                return;
            }
            ...
            sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <blue>" + target.getName() + " has been added to your global trust list.</blue>"));
            target.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <blue>" + sender.getName() + " has added you to their global trust list.</blue>"));
        }
        else {
            List<String> trusted = player.getLocalTrustList();
            if (trusted == null) {
                sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <red>You are not within a claim!</red>"));
                return;
            }
            ...
            if (!trusted.contains(target.getUniqueId().toString())) {
                ...
                sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <red>That player is already trusted!</red>"));
                return;
            }
            ...
            sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <blue>" + target.getName() + " has been added to your trusted list.</blue>"));
            target.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <blue>" + sender.getName() + " has added you to their trusted list.</blue>"));
        }
    }
    ...
    private static Player getTarget(Player sender, String argument) {
        ...
        if (target == null){
            sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <red>That player is not online!</red>"));
            return null;
        }
    ...
    private static boolean insideTrustedClaim(Player sender, ShopsharePlayer player) {
        ...
        sender.sendMessage(miniMessage.deserialize("<aqua>[CSE]</aqua> <red>You do not have chest permissions in this claim!</red>"));
        return false;
    }
}
